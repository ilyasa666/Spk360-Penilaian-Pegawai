<?php
	...
	if(isset($_POST['btnSimpan'])){
		...
		$guru_1 = isset($_POST['guru_1'])?mysqli_real_escape_string($con, htmlspecialchars($_POST['guru_1'])):"";
		$guru_2 = isset($_POST['guru_2'])?mysqli_real_escape_string($con, htmlspecialchars($_POST['guru_2'])):"";
		$guru_3 = isset($_POST['guru_3'])?mysqli_real_escape_string($con, htmlspecialchars($_POST['guru_3'])):"";
		...
		if($btn=="Tambah"){
			...
			}else if($query && $guru_1 !== "") {
				$last_id = mysqli_insert_id($con);
				$sql2 = "INSERT INTO penilai_detail ( id_penilai, nip) VALUES ('$last_id', '$guru_1'),('$last_id', '$guru_2')";
				$query2 = mysqli_query($con, $sql2);
				if($query2){
					$cek = true;
				}
